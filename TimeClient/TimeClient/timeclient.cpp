...
TimeClient::TimeClient(QWidget *parent)
    : QDialog(parent)
{
    setWindowTitle(QStringLiteral("多线程时间服务器编程"));
    serverNameLabel = new QLabel(QStringLiteral("服务器名:"));
    ...
    stateLabel = new QLabel(QStringLiteral("请首先运行时间服务器"));
    QHBoxLayout *layout2 = new QHBoxLayout;
    layout2->addWidget(stateLabel);
    getBtn = new QPushButton(QStringLiteral("获取时间"));
...
void TimeClient::showError(QAbstractSocket::SocketError socketError)
{
    ...
    case QAbstractSocket::HostNotFoundError:
        QMessageBox::information(this,QStringLiteral("时间服务器客户端"),QStringLiteral("连接被拒绝！"));
        break;
    default:
        QMessageBox::information(this,QStringLiteral("时间服务客户端"),QStringLiteral("产生如下错误：%1.").arg(tcpSocket->errorString()));
        break;
    }
    getBtn->setEnabled(true);
}
