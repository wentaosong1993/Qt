    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->mainToolBar->addAction(QStringLiteral("当前项目"), this, &MainWindow::getCurrentItemData);
    ui->mainToolBar->addAction(QStringLiteral("切换选择"), this, &MainWindow::toggleSelection);
