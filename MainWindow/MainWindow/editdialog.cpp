    ...
    :QDialog(parent)
{
    ...
    setLayout(layout);
    setWindowTitle(QStringLiteral("添加产品"));
}
...
void EditDialog::submit()
{
    ...
    {
        QString message(QStringLiteral("请输入厂名、厂址和商品名称！"));
        QMessageBox::information(this,QStringLiteral("添加产品"),message);
    }
    else
    {
...
QDialogButtonBox *EditDialog::createButtons()
{
    ...
    QPushButton *revertButton = new QPushButton(QStringLiteral("撤销"));
    QPushButton *submitButton = new QPushButton(QStringLiteral("提交"));
...
{
    QGroupBox *box = new QGroupBox(QStringLiteral("添加产品:"));
    QLabel *factoryLabel = new QLabel(QStringLiteral("制造商:"));
    QLabel *addressLabel =  new QLabel(QStringLiteral("厂址:"));
    QLabel *carLabel = new QLabel(QStringLiteral("品牌:"));
    QLabel *yearLabel = new QLabel(QStringLiteral("上市时间:"));
    QLabel *attribLabel = new QLabel(QStringLiteral("产品属性(由分号;隔开):"));
